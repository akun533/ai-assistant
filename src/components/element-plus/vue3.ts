 ...
 * 定义每个组件类型对应的分类
 */
export function getElementPlusCategory(componentType: string): ComponentCategory | undefined {
 ...
 * 定义在提示词中如何展示分组
 */
export function getElementPlusSections() {
  return [
    {
      title: 'Field 表单组件',
 ...
 */
export function getElementPlusPrompt(): string {
  try {
 ...
 * Element Plus 组件使用说明
 */
export function getElementPlusUsages(): Record<string, string> {
  return {
