...
/**
 * Ant Design Vue (Vue3) 组件分类规则
 */
export function getAntDesignVueCategory(componentType: string): ComponentCategory | undefined {
...
/**
 * Ant Design Vue (Vue3) 组件分组展示配置
 */
export function getAntDesignVueSections() {
  return [
    {
      title: 'Field 表单组件',
 ...
 */
export function getAntDesignVuePrompt(): string {
  try {
 ...
 */
export function getAntDesignVueUsages(): Record<string, string> {
  return {
